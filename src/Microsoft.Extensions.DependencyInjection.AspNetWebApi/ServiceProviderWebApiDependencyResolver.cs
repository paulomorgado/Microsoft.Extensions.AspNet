...
{
    internal sealed class ServiceProviderWebApiDependencyResolver : IDependencyResolver
    {
        private readonly IServiceProvider serviceProvider;

        public ServiceProviderWebApiDependencyResolver(IServiceProvider serviceProvider)
        {
